...
import { ColorPickerDemoScreen } from './src/screens/ColorPickerDemoScreen';
...
const MatchsStack = () => (
  ...
  >
    ...
    <Stack.Screen 
      name="AddMatch" 
      component={AddMatchScreenShadcn}
      options={{ 
        title: 'Nouveau Match',
        headerRight: () => (
          <Icon 
  ...
  return (
    <NavigationContainer>
      ...
      >
        ...
        <Tab.Screen 
          name="Dashboard" 
          component={DashboardScreenShadcn}
          options={{
            title: 'Mon Dashboard',
        ...
        <Tab.Screen 
          name="Classement" 
          component={ClassementScreenShadcn}
          options={{
        ...
        <Tab.Screen 
          name="ColorDemo" 
          component={ColorPickerDemoScreen}
          options={{
